...
1. Continue route-order sprite wiring at `chapter-three/cargo-cart-turntable`.
2. Review whether Cargo Cart Turntable should keep its existing hand-built turntable art or swap to `cargo-cart-turntable-painted.png`.
