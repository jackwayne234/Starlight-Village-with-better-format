...
1. Continue route-order sprite wiring at `chapter-four/cloud-harvester`.
2. Review whether Cloud Harvester should use `cloud-harvester-painted.png` or keep/improve a bespoke side-view treatment.
