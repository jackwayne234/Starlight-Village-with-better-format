...
1. Continue route-order sprite wiring at `chapter-three/mossline-switchyard`.
2. Review whether Mossline Switchyard should keep its existing hand-built switchyard art or swap to `mossline-switchyard-painted.png`.
