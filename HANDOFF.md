...
1. Continue route-order sprite wiring at `chapter-four/cliff-rope-lift`.
2. Review whether Cliff Rope Lift should use `cliff-rope-lift-painted.png` or keep/improve a bespoke side-view treatment.
