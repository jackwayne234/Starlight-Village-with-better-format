...
1. Continue route-order sprite wiring at `chapter-four/weather-vane-roof`.
2. Review whether Weather Vane Roof should use `weather-vane-roof-painted.png` or keep/improve a bespoke side-view treatment.
