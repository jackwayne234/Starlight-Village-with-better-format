...
1. Wire `chapter-two/reedwatch-bank` next using the shared `paintedLandmark` pattern.
2. Continue Chapter 2 route-order wiring scene by scene after Glowfen Ferry.
