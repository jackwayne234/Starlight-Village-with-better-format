...
Run a user playtest of Chapter 2 as a complete wetland-biome pass.

Next likely stop:

1. Start from Festival Square or Wetland Approach.
2. Play through Wetland Approach, Glowfen Grove, Lantern Lily Pool, Bog Bridge, Frogsong Lock, Sunken Signpost, Mist Pool, Moss Gate, Old Fen Shrine, Glowfen Ferry, and Reedwatch Bank.
3. Confirm Reedwatch Bank advances into Mossline Switchyard.
4. Note any human-feel issues around puzzle difficulty, pacing, route clarity, or scene-to-scene variety in a new playtest chunk.
