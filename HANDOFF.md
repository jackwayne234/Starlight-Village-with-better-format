...
1. Continue route-order sprite wiring at `chapter-three/last-platform`.
2. Review whether Last Platform should use `last-platform-painted.png` or keep/improve its existing bespoke side-view platform treatment.
