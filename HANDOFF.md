...
1. Continue route-order sprite wiring at `chapter-four/stormedge-rise`.
2. Review whether Stormedge Rise should use `stormedge-rise-painted.png` or keep/improve its existing bespoke side-view chapter-landmark treatment.
